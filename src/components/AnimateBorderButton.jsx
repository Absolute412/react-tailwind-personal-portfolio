...
export const AnimatedBorderButton = ({ children, href, target, rel }) => {
  return (
    <a
      href={href}
      target={target}
      rel={rel}
      className="relative inline-flex items-center justify-center gap-2 bg-transparent border border-border 
