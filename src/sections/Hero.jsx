        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="animate-fade-in">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary">
                <span className="w-2 h-2 bg-primary rounded-full animate-pulse" />
                  Software Engineer<strong>·</strong>React Specialist
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I’m Alvin Egwuonye — a frontend-focused developer building clean, 
                responsive web applications using React, Tailwind CSS, and real-world APIs.
              </p>
            </div>
          ...
          <div className="relative animate-fade-in animation-delay-300">
            ...
            <div className="relative max-w-md mx-auto">
              <div 
                className="
                  absolute inset-0 rounded-3xl bg-linear-to-br
