      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
          ...
          <p className="text-muted-foreground animate-fade-in animation-delay-200">
            A selection of my most recent work, from complex web applications to innovative tools that solve real-world problems.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start justify-between">
                  ...
                  <ArrowUpRight 
                    className="
                      w-f5 h-5 text-muted-foreground group-hover:text-primary
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag, tagIdx) => (
                    <span
                      key={tagIdx} 
                      className="
                        px-4 py-1.5 rounded-full bg-surface text-xs font-medium border border-border/50 
